crud.components.cManage = Vue.component('c-manage',{
    ...
    data : function () {
        ...
        var actionSaveBack = thisManage.merge(thisManage.$crud.actions['action-save-back'], {
                afterExecute: function () {
                ...
                customActions : {
                    'action-edit' : {
                        execute : function () {
                            ...
                            var pkTranslation = that.translate(modelName+"."+editConf.primaryKey+'.label');
                            thisManage.updateTitle = 'Modifica ' + modelName + ' ('+
                                pkTranslation +
                                ':' + that.modelData[editConf.primaryKey] + ')';
