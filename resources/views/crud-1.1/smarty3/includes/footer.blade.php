...
<footer id="footer">
    <div class="{{$layoutGradientColor}} rounded text-white p-3 fs--14">
        ...
        <div class="z-index-1">
            ...
            {{--                        <a id="topDDLanguage" href="#!" class="d-inline-block text-white" data-toggle="dropdown" aria-expanded="false" aria-haspopup="true">--}}
            ...
            {{--                        <a id="topDDCurrency" href="#" class="d-inline-block text-white" data-toggle="dropdown" aria-expanded="false">--}}
