...
class Role extends Breeze implements RoleContract
{
    use HasPermissions;
    use RefreshesPermissionCache;


    public $columnsForSelectList = ['name'];

    public $defaultOrderColumns = array('name' => 'ASC');

    public $columnsSearchAutoComplete = array('name');
